# Generated by Django 5.1.4 on 2025-06-24 12:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='outcome_code',
            field=models.CharField(choices=[('P00010', 'Passed'), ('N00010', 'Not Applicable'), ('E00001', 'Syntax Error'), ('E00011', 'Syntax Header Error'), ('E00002', 'Schema Error'), ('E00010', 'Type Error'), ('E00020', 'Value Error'), ('E00030', 'Geometry Error'), ('E00040', 'Cardinality Error'), ('E00050', 'Duplicate Error'), ('E00060', 'Placement Error'), ('E00070', 'Units Error'), ('E00080', 'Quantity Error'), ('E00090', 'Enumerated Value Error'), ('E00100', 'Relationship Error'), ('E00110', 'Naming Error'), ('E00120', 'Reference Error'), ('E00130', 'Resource Error'), ('E00140', 'Deprecation Error'), ('E00150', 'Shape Representation Error'), ('E00160', 'Instance Structure Error'), ('W00010', 'Alignment Contains Business Logic Only'), ('W00020', 'Alignment Contains Geometry Only'), ('W00030', 'Warning'), ('X00040', 'Executed')], default='N00010', help_text='Code representing the Validation Outcome.', max_length=10),
        ),
        migrations.AlterField(
            model_name='validationtask',
            name='type',
            field=models.CharField(choices=[('SYNTAX', 'STEP Physical File Syntax'), ('SYNTAX_HEADER', 'STEP Physical File Syntax (HEADER; section)'), ('SCHEMA', 'Schema (EXPRESS language)'), ('MVD', 'Model View Definitions'), ('BSDD', 'bSDD Compliance'), ('INFO', 'Parse Info'), ('PREREQ', 'Prerequisites'), ('HEADER', 'Header Validation'), ('NORMATIVE_IA', 'Implementer Agreements (IA)'), ('NORMATIVE_IP', 'Informal Propositions (IP)'), ('INDUSTRY', 'Industry Practices'), ('INST_COMPLETION', 'Instance Completion'), ('DIGITAL_SIGNATURES', 'Digital Signatures')], db_index=True, help_text='Type of the Validation Task.', max_length=25),
        ),
    ]
