# Generated by Django 4.2.9 on 2024-01-27 11:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_code', models.CharField(choices=[('P00010', 'Passed'), ('N00010', 'Not Applicable'), ('E00001', 'Syntax Error'), ('E00010', 'Type Error'), ('E00020', 'Value Error'), ('E00030', 'Geometry Error'), ('E00040', 'Cardinality Error'), ('E00050', 'Duplicate Error'), ('E00060', 'Placement Error'), ('E00070', 'Units Error'), ('E00080', 'Quantity Error'), ('E00090', 'Enumerated Value Error'), ('E00100', 'Relationship Error'), ('E00110', 'Naming Error'), ('E00120', 'Reference Error'), ('E00130', 'Resource Error'), ('E00140', 'Deprecation Error'), ('E00150', 'Shape Representation Error'), ('E00160', 'Instance Structure Error'), ('W00010', 'Alignment Contains Business Logic Only'), ('W00020', 'Alignment Contains Geometry Only'), ('W00030', 'Warning'), ('X00040', 'Executed')], default='N00010', help_text='Code representing the Validation Outcome.', max_length=10)),
