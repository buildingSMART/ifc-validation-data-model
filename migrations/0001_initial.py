    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, help_text='What Company this Authoring Tool belongs to (optional).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='company', to='ifc_validation_models.company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.ifc_validation_models.models.IdObfuscator),
        ),
        migrations.CreateModel(
            name='ModelInstance',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.BooleanField(db_index=True, default=False, help_text='Flag to indicate object is deleted')),
                ('created', models.DateTimeField(auto_now_add=True, help_text='Timestamp this instance was created.')),
                ('updated', models.DateTimeField(blank=True, help_text='Timestamp this instance was last updated.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SYNTAX', 'STEP Physical File Syntax'), ('SCHEMA', 'Schema (EXPRESS language)'), ('MVD', 'Model View Definitions'), ('BSDD', 'bSDD Compliance'), ('INFO', 'Parse Info'), ('PREREQ', 'Prerequisites'), ('NORMATIVE_IA', 'Implementer Agreements (IA)'), ('NORMATIVE_IP', 'Informal Propositions (IP)'), ('INDUSTRY', 'Industry Practices'), ('INST_COMPLETION', 'Instance Completion')], db_index=True, help_text='Type of the Validation Task.', max_length=25)),
