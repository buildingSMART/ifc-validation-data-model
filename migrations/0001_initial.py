# Generated by Django 4.2.9 on 2024-01-23 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produced_by', models.ForeignKey(blank=True, help_text='What tool was used to create this Model.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='models', to='ifc_validation_models.ifcauthoringtool')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text='Who created this instance', on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('model', models.OneToOneField(help_text='What Model is created based on this Validation Request.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='request', to='ifc_validation_models.ifcmodel')),
                ('updated_by', models.ForeignKey(blank=True, help_text='Who updated this instance.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text='Who created this instance', on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('request', models.ForeignKey(help_text='What Validation Request this Validation Task belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='ifc_validation_models.ifcvalidationrequest')),
                ('updated_by', models.ForeignKey(blank=True, help_text='Who updated this instance.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text='Who created this instance', on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('instance', models.ForeignKey(help_text='What Model Instance this Outcome is applicable to (optional).', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='outcomes', to='ifc_validation_models.ifcmodelinstance')),
                ('updated_by', models.ForeignKey(blank=True, help_text='Who updated this instance.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(blank=True, help_text='What Company this Authoring Tool belongs to (optional).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='company', to='ifc_validation_models.ifccompany'),
        ),
        migrations.AddField(
            model_name='ifcauthoringtool',
            name='created_by',
